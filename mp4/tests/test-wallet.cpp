...
// TEST_CASE("wallet safely stores the resource name", "[part=extra]") {
//   // Create and initialize the wallet
//   wallet_t wallet;
//   wallet_init(&wallet);

//   char *r1 = (char*)malloc(100);
 
//   strcpy(r1, "apple");
//   wallet_change_resource(&wallet, r1, 1);

//   strcpy(r1, "pear");
//   wallet_change_resource(&wallet, r1, 2);

//   strcpy(r1, "orange");
//   wallet_change_resource(&wallet, r1, 3);

//   REQUIRE( wallet_get(&wallet, "apple") == 1 );
//   REQUIRE( wallet_get(&wallet, "pear") == 2 );
//   REQUIRE( wallet_get(&wallet, "orange") == 3 );
